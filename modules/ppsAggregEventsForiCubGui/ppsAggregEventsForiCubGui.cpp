...
*
* The module that transforms aggregated tactile/peripersonal space events, as generated by skinEventsAggegator/visuoTactileRF, into a skinContactList output that can be sent to/iCubGui/forces and visualized.
*  
*/
