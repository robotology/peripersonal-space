...
public:
    ...
    **/
    ...
    parzenWindowEstimator(const double e, const int hs);
...
public:
    ...
    **/
    ...
    /**
    * Get the value of the receptive field at a certain position - using interpolation (bilinear in the 2D case)
    **/
    double getF_X_interpolated(const std::vector<double> x);
